...
const Log = createLogger("WEB DIET CONTROLLER");
...
class DietController extends Controller {
  ...
  create = async (req, res) => {
    ...
    try {
      ...
      Log.debug("Create request body: ", body);
      ...
      Log.debug("Create 500 error - diet create web error: ", error);
      return raiseServerError(res);
    }
  };
