...
import {EVENT_TYPE, USER_CATEGORY, EVENT_LONG_TERM_VALUE} from "../../../constant";
...
export const createVitals = async ({data = [], carePlanId, authUser, patientId}) => {
  try {
      ...
      const {userId: authUserId, category: authCategory,
         userCategoryData: authUserCategoryData, userRoleId: authUserRole} = authUser || {};
