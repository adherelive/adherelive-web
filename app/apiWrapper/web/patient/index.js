...
class PatientWrapper extends BasePatient {
  ...
  getAllInfo = async () => {
    ...
    // logger.debug("getAllInfo in PatientWrapper has _data, should get Patient ID: ", _data);
    // logger.debug("getAllInfo in PatientWrapper has getBasicInfo as: ", getBasicInfo());
    ...
    // logger.debug("getAllInfo in PatientWrapper has data patient_id as: ", data);
  ...
  getReferenceInfo = async () => {
    ...
    // logger.debug("getReferenceInfo in PatientWrapper has PatientID/User as: ", users);
