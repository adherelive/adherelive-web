...
class MobileDoctorRegistrationWrapper extends BaseDoctorRegistration {
    constructor(data) {
        super(data);
    }
...
export default async (data = null, id = null) => {
    if (data) {
        return new MobileDoctorRegistrationWrapper(data);
    }
    const doctorRegistration = await doctorRegistrationService.getRegistrationById(id);
    return new MobileDoctorRegistrationWrapper(doctorRegistration.get());
};