...
class DietFoodGroupMappingWrapper extends BaseDietFoodGroupMapping {
    ...
    getAllInfo = async () => {
        ...
        const {count = null , rows = []} = await similarFoodMappingService.findAndCountAll({
    ...
    getReferenceInfo = async() => {
        ...
        let portionsApiData = {} , foodGroupsApiData = {}, foodItemDetailsApiData = {},foodItemsApiData = {} , similarFoodMappingApiData = {};
        ...
        const {food_groups = {} , portions = {} , food_item_details = {} , food_items = {} } = 
        ...
        if (similar_food_mappings.length > 0) {
            for (let index = 0; index < similar_food_mappings.length; index++) {
              const SimilarFoodMapingDetail = 
                await SimilarFoodMappingWrapper({ data: similar_food_mappings[index] });
...
export default async ({data = null, id = null}) => {
    ...
    const dietFoodGroupMapping = await dietFoodGroupMappingService.getByData({ id });
