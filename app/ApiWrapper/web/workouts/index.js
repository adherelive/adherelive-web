  ...
  getAllInfo = () => {
    ...
    if (exerciseMappings.length > 0) {
      ...
      for (let index = 0; index < exerciseMappings.length; index++) {
        ...
        // workout_exercise_group_mapping_ids.push(workout_exercise_group_mapping_id);
      }
    }
    return {
      ...getBasicInfo(),
  ...
  getReferenceInfo = async () => {
    ...
    if (exerciseMappings.length > 0) {
      ...
      for (let index = 0; index < exerciseMappings.length; index++) {
        ...
        // allWorkoutExerciseGroupMappings = {...allWorkoutExerciseGroupMappings, ...workout_exercise_group_mappings};
      }
    }
