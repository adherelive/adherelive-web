...
class DietWrapper extends BaseDiet {
    ...
    getReferenceInfo = async() => {
        ...
        let  dietFoodGroupMappingData = {} , dietsApiData = {} , foodGroupsApiData = {}  , portionsApiData = {}, foodItemsApiData = {} , foodItemDetailsApiData = {} ;
        let careplanApiData = {} , similiarFoodMappingApiData;
        ...
        if(dietFoodGroupMappings.length>0){
            for( let i = 0 ; i< dietFoodGroupMappings.length ; i++ ){
                ...
                const dietFoodGroupMappingWrapper = await DietFoodGroupMappingWrapper({id});
                ...
                dietFoodGroupMappingData =  { ...dietFoodGroupMappingData, ...diet_food_grouping_mappings };
                ...
                foodItemDetailsApiData = {...foodItemDetailsApiData, ...food_item_details};
                similiarFoodMappingApiData = { ...similiarFoodMappingApiData , ...similar_food_mappings };

            }
        }

        careplanApiData[careplanData.getCarePlanId()] =await  careplanData.getAllInfo();
