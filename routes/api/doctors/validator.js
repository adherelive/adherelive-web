...
const addDoctorForm = Joi.object().keys({
  ...
  is_provider: Joi.boolean().optional().allow("", null),
  doctor_id: Joi.number()
    .optional()
    .allow("", null)
    .label("Incorrect doctor selected"),
  existing: Joi.boolean().optional().allow("", null),
  existingDoctorId: Joi.string().optional().allow("", null),
});
...
const addQualificationRegistrationForm = Joi.object().keys({
  ...
  speciality_id: Joi.string().required().label("Speciality is required"),
  doctor_id: Joi.number().optional().allow("", null),
  qualification_details: Joi.array().items(
    Joi.object().keys({
      college_id: Joi.string().optional().allow(""),
      ...
      photos: Joi.array().items(
        Joi.string().uri().label("Please upload valid qualification document")
      ),
  ...
  registration_details: Joi.array().items(
    Joi.object().keys({
      ...
      photos: Joi.array().items(
        Joi.string().uri().label("Please upload valid registration document")
      ),
      id: Joi.number().optional().allow(0, null),
      photo: Joi.array().optional().allow(""),
    })
...
const addClinicsForm = Joi.object().keys({
  ...
  clinics: Joi.array().items(
    Joi.object().keys({
      ...
      clinic_id: Joi.number().optional().allow("", null),
    })
  ),
});
