    ...
    renderAddAccountDetailsForm = () => {
        ...
        return (
            <div className='form-block-ap'>
                ...
                <div>
                    <div
                        className='form-headings flex align-center justify-start'>{this.formatMessage(messages.linkedAccountName)}
                    ...
                    <div
                        className='form-headings flex align-center justify-start'>{this.formatMessage(messages.contactNumber)}
                        <div className="star-red">*</div>
                    </div>
                ...
                <div>
                    <div
                        className='form-headings flex align-center justify-start'>{this.formatMessage(messages.accountNumber)}
                        <div className="star-red">*</div>
                    </div>
                    ...
                    <div
                        className='form-headings flex align-center justify-start'>{this.formatMessage(messages.accountType)}
                        <div className="star-red">*</div>
                    </div>
                    ...
                    <div
                        className='form-headings flex align-center justify-start'>{this.formatMessage(messages.enterUPIID)}</div>
                    ...
                    <div className='form-headings flex align-center justify-start'>{this.formatMessage(messages.ifsc)}
                        <div className="star-red">*</div>
                    </div>
                    ...
                    <div
                        className='form-headings flex align-center justify-start'>{this.formatMessage(messages.useAsMainAccount)}</div>
