...
class editAccountDetailsDrawer extends Component {
    ...
    renderAddAccountDetailsForm = () => {
        const {customer_name = '',account_mobile_number = '',prefix="91",account_type ='',ifsc_code ='',account_number ='',use_as_main=true,upi_id=null} = this.state;
    ...
    onSubmit = () => {
        ...
        const { customer_name = '', account_mobile_number = '', prefix = '', account_number = '', ifsc_code = '', account_type = '' , use_as_main=false,upi_id=null} = this.state;
