...
export default props => {
    ...
    return (
        <Fragment>
            ...
            >
                <RadioButton value={1}
                             onClick={props.setRepeatEveryDay}>{props.formatMessage(messages.everyday)}</RadioButton>
                <RadioButton value={2}
                             onClick={props.setRepeatAlternateDay}>{props.formatMessage(messages.alternate)}</RadioButton>
            </RadioGroup>
            ...
            >
                <RadioButton value={1}
                             onClick={props.setEndDateOneWeek}>{props.formatMessage(messages.oneWeek)}</RadioButton>
                <RadioButton value={2}
                             onClick={props.setEndDateTwoWeek}>{props.formatMessage(messages.twoWeeks)}</RadioButton>
                <RadioButton value={3}
                             onClick={props.setEndDateLongTime}>{props.formatMessage(messages.longterm)}</RadioButton>
            </RadioGroup>
