...
class AddFoodGroup extends Component {
  ...
  handleSubmit = (e) => {
    ...
    validateFields(async (err, values) => {
      if (!err) {
        ...
        let data = { // will be used to display food group details in diet drawer
        ...
        const updateData={ // will be used to update the details of food item
          name:food_item_name,
          portion_id : portion_id ? parseInt(portion_id) : null,
          ...
          try {
            ...
            if(editable){
              ...
              const {status,payload:{data:resp_data={},message:resp_msg=''} ={} } = responseOnUpdate;
  ...
  render() {
    ...
    const { disabledSubmit ,
      submitting=false , visibleAddFoodDrawer = false , 
      food_item_detail_id = null ,editable=false , food_item_name = '' } = this.state;
