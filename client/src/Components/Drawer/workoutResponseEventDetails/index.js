        ...
        return (
            <div className="flex direction-column wp100 b-light-grey p10 br5 mt20">
                <div className=" fs16 fw800 flex ">
                    ...
                    <div
                        className={`${src.length > 0 ? "ml10" : "null"} flex direction-column align-center justify-center`}>
                        {name}
                    </div>

                </div>
                <div>
                    {`${sets}x${" "}${repetition_value}${" "}${type}`}<span
                    className="grey-dot">&bull;</span>{`${calorific_value ? calorific_value : "--"} Cal`}
                </div>
