...
class addAccountDetailsDrawer extends Component {
    ...
    renderAddAccountDetailsForm = () => {
        const {customer_name='',account_mobile_number='',prefix="91",account_type='',ifsc_code='',account_number='',use_as_main=false,upi_id=''} = this.state;
            ...
            <div className='form-block-ap'>
                ...
                //    flex align-center justify-start
                   tac'>
                    ...
                    <div>
                        <div className='form-headings flex align-center justify-start'>{this.formatMessage(messages.linkedAccountName)}<div className="star-red">*</div></div>
                        ...
                        <div className='form-headings flex align-center justify-start'>{this.formatMessage(messages.contactNumber)}<div className="star-red">*</div></div>
                    ...
                    tac'>
                        ...
                        <div>
                        <div className='form-headings flex align-center justify-start'>{this.formatMessage(messages.accountNumber)}<div className="star-red">*</div></div>
                        ...
                        <div className='form-headings flex align-center justify-start'>{this.formatMessage(messages.accountType)}<div className="star-red">*</div></div>
                        ...
                        <div className='add-patient-radio  wp100 mt6 mb18 flex'>
                            ...
                            >
                                <Radio.Button 
                                style={{width:"40%",marginBottom:"10px",marginTop:"10px"}}
                                value={SAVINGS} 
                                onClick={() => {this.setAccountType(SAVINGS)}}
                                >{ACCOUNT_TYPES[SAVINGS]}</Radio.Button>

                                <Radio.Button 
                                style={{width:"40%",marginBottom:"10px",marginTop:"10px"}}
                                value={CURRENT} 
                                onClick={() => {this.setAccountType(CURRENT)}}
                                >{ACCOUNT_TYPES[CURRENT]}</Radio.Button>
                            </Radio.Group>
                        </div>
                        
                        <div className='form-headings flex align-center justify-start'>{this.formatMessage(messages.enterUPIID)}</div>
                        ...
                        <div className='form-headings flex align-center justify-start'>{this.formatMessage(messages.ifsc)}<div className="star-red">*</div></div>
                        ...
                        >
                            <span className="fs20 ml10" >{this.formatMessage(messages.yes)}</span>
                        </Checkbox>
    ...
    validateData = () => {
        ...
        if (!prefix) {
            ...
            return false;
        } else if (account_mobile_number.length < 6 || account_mobile_number.length > 20 || !account_mobile_number) {
    ...
    submit = ({ customer_name, account_mobile_number,prefix,account_number,ifsc_code,account_type,use_as_main=false,upi_id}) => {
       
        this.handleSubmit({ customer_name, account_mobile_number,prefix,account_number,ifsc_code,account_type,use_as_main,upi_id});
        

    }

    async handleSubmit({ customer_name, account_mobile_number,prefix,account_number,ifsc_code,account_type,use_as_main,upi_id}){

        try {
            const {addAccountDetails,updateAccountDetailsAdded} = this.props;
            const response = await addAccountDetails({ customer_name, account_mobile_number,prefix,account_number,ifsc_code,account_type,use_as_main,upi_id});
    ...
    onSubmit = () => {
        ...
        const { customer_name = '', account_mobile_number = '', prefix = '', account_number = '', ifsc_code = '', account_type = '' , use_as_main=false , upi_id=''} = this.state;
        const validate = this.validateData();
        const { submit } = this;
        if (validate) {
            submit({ customer_name, account_mobile_number,prefix,account_number,ifsc_code,account_type,use_as_main,upi_id})
        }
    }
