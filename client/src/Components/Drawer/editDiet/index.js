...
class EditDiet extends Component{
    ...
    getDietDetails = async() => {
      try{
        ...
        const {status, payload: {data = {} , message : resp_msg = '' } = {} } = response || {};
    ...
    handleSubmit = async() => {
      ...
      const {updateDiet , carePlanId : care_plan_id = null , payload ,  addTemplateDiet = null , editTemplateDiet =null  } = this.props;
      const {completeData : diet_food_groups = {} ,total_calories = 0 ,deletedFoodGroupIds = [] } = this.state;
      ...
      validateFields(async (err, values) => {
        ...
        if (!err ) {
          ...
          if(name.length === 0 ||
            ...
            (addTemplateDiet === null && editTemplateDiet === null ) && !care_plan_id 
            ){
          ...
          if(addTemplateDiet === null && editTemplateDiet === null ){ // normal edit diet
    ...
    handleDelete = () => {
      ...
      const { warnNote } = this;
      const { payload : {diet_id = null ,patient_id } = {} , getPatientCarePlanDetails } = this.props || {};
    ...
    getDeleteButton = () => {
      ...
      return (
        <Button
          ...
          onClick={
            deleteDietOfTemplate ? deleteDietOfTemplate : handleDelete
          }
          loading={loading}
        >
    ...
    return (
        <Fragment>
          <Drawer
            ...
            destroyOnClose={true}
            onClose={
              addTemplateDiet || editTemplateDiet
              ? hideDiet
              : onClose
            }
            visible={ 
