...
class DietFieldsFrom extends Component {
  ...
  componentDidMount(){
    ...
    if(editTemplateDiet){
      const {details:{repeat_days : template_r_days=[]}={}}=dietData || {};
  ...
  render() {
    ...
    if(editTemplateDiet !== null){
      ...
      duration=null,start_date :temp_start_date = null, end_date : temp_end_date = null, details:{ not_to_do :template_not_to_do = '' }={}}=dietData || {};
