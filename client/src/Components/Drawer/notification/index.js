...
import {Drawer, Form, message, Select} from "antd";
...
class NotificationDrawer extends Component {
    ...
    getSingleNotification = (notification) => {
            ...
            dataToRender = (
                ...
                >
                    <div className=" flex align-center justify-space-between">
                        ...
                        <div className="wp75">
                            <div className="fs16 medium">{title}</div>
                            <div className="fs14">{formatMessage(
        ...
        return dataToRender ?
            <div id={notification_id} key={`notification-${notification_id}`}>{dataToRender}</div> : null;
    };
