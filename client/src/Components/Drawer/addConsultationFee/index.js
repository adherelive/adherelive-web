...
class addNewConsultationDrawer extends Component {
    ...
    getConsultationOptions = () => {
        ...
        let options = [];
            ...
            for( let each in defaultPaymentsProducts){
                const { basic_info:{id = null ,name ='',type=''} = {}} =defaultPaymentsProducts[each] || {};
                options.push(
    ...
    renderAddNewConsultationFee = () => {
        ...
        const {selectedFeeRadio = '',newConsultationName = '', newConsultationType = '',newConsultationTypeText='', newConsultationFee = ''}=this.state;
        return (
                ...
                >
                   {this.getConsultationOptions()}
                        ...
                        <div>
                            ...
                            (
                                <div>
                                    <div className='form-headings flex align-center justify-start'>{this.formatMessage(messages.consultationFeeName)}<div className="star-red">*</div></div>
                                    ...
                                    <div className='form-headings flex align-center justify-start'>{this.formatMessage(messages.consultationFeeType)}<div className="star-red">*</div></div>
                                    ...
                                    <div className='form-headings flex align-center justify-start'>{this.formatMessage(messages.consultationFee)}<div className="star-red">*</div></div>
    ...
    onSubmit = () => {
        ...
        const {newConsultationName='',
            newConsultationType="",
            newConsultationFee='', } = this.state;
    ...
    async handleSubmit (data) {
        ...
        try {
            ...
            const { status, payload: {  data :{payment_products = {} ,message : payload_message =''} = {}  } = {} } =
            response || {};
                if (status) {
