...
class TemplatePageCreateDrawer extends Component {
    ...
    deleteEntry = () => {
        let {
            ...
            medications = {}, diets = {}, workouts = {}, medicationKeys = [],
            vitals = {}, vitalKeys = [], dietKeys = [], workoutKeys = [],
    ...
    onSubmit = async () => {
        ...
        const {createCareplanTemplate, close, authenticated_category} = this.props;
    ...
    onClose = () => {
        ...
        if (name || medicationKeys.length || appointmentKeys.length || vitalKeys.length || dietKeys.length || workoutKeys.length) {
        ...
        return (
            <div className='template-block'>
                <div className='wp100 flex direction-row align-center '>
                    <div className='form-category-headings-ap mr0-I'>{this.formatMessage(messages.name_text)}</div>
                ...
                <div className='wp100 flex align-center justify-space-between'>
                    <div className='form-category-headings-ap '>{"Medications"}</div>
                    {
                        medicationKeys.length > 0
                            ...
                            :
                            <div className='add-more'
                                 onClick={this.showAddMedication}>{this.formatMessage(messages.add)}</div>
                    }
                ...
                <div className='wp100 flex align-center justify-space-between'>
                        ...
                        className='form-category-headings-ap align-self-start'>{this.formatMessage(messages.appointments)}</div>
                    {
                        appointmentKeys.length > 0
                            ...
                            :
                            <div className='add-more'
                                 onClick={this.showAddAppointment}>{this.formatMessage(messages.add)}</div>
                    }
                </div>
                {
                        ...
                        return (
                            ...
                            <div className='flex wp100 flex-grow-1 align-center' key={key}>
                                <div className='drawer-block'>
                                    ...
                                    <div
                                        className='drawer-block-description'>{date ? `After ${(moment(date).diff(moment(), 'days')) + 1} days` : time_gap ? `After ${time_gap} days` : ''}</div>
                ...
                <div className='wp100 flex align-center justify-space-between'>
                        ...
                        className='form-category-headings-ap align-self-start'>{this.formatMessage(messages.actions)}</div>
                    {
                        vitalKeys.length > 0
                            ?
                            <div className='add-more'
                                 onClick={this.showAddVital}>{this.formatMessage(messages.addMore)}</div>
                            :
                            <div className='add-more'
                                 onClick={this.showAddVital}>{this.formatMessage(messages.add)}</div>
                    }
                </div>
                {
                ...
                <div className='wp100 flex align-center justify-space-between'>
                        ...
                        className='form-category-headings-ap align-self-start'>{this.formatMessage(messages.diets)}</div>
                    {
                        dietKeys.length > 0
                            ?
                            <div className='add-more'
                                 onClick={this.showAddDiet}>{this.formatMessage(messages.addMore)}</div>
                            :
                            <div className='add-more'
                                 onClick={this.showAddDiet}>{this.formatMessage(messages.add)}</div>
                    }
                </div>
                {
                ...
                <div className='wp100 flex align-center justify-space-between'>
                        ...
                        className='form-category-headings-ap align-self-start'>{this.formatMessage(messages.workouts)}</div>
                    {
                        workoutKeys.length > 0
                            ?
                            <div className='add-more'
                                 onClick={this.showAddWorkout}>{this.formatMessage(messages.addMore)}</div>
                            :
                            <div className='add-more'
                                 onClick={this.showAddWorkout}>{this.formatMessage(messages.add)}</div>
                    }
                </div>
                {
    ...
    render() {
        ...
        console.log("673246238462834628346827364872634872634872", {innerFormKey, innerFormType});
