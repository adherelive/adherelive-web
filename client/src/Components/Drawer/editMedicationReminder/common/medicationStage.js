...
class MedicationStage extends Component {
  ...
  searchOptions = ({hit}) => {
    ...
    return (
        <div  key={medicine_id} className="pointer flex wp100  align-center justify-space-between" 
  ...
  render() {
    ...
    const {isSearching = false} = this.state;
    const { fetchingMedicines,medicine_name='' , medicine_id =null ,searching_medicine=false } = this.state;
                  ...
                  (
                    <>
                        ...
                        <span style={{marginLeft:"5px"}}>
                            <EditOutlined onClick = {this.isSearchingMedicine} title={"Edit Medicine"}/>
                        </span>
                    </>
                )
          :
