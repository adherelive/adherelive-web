            ...
            ...this.state
                    ...
                    <div className="flex align-items-end justify-content-space-between">
                        ...
                        <div className="mg-ml-radio-group flex-grow-0">
                            ...
                            >
                                <RadioButton value={MEDICINE_UNITS.ML}
                                             className={medicineUnit !== MEDICINE_UNITS.ML ? `unselected-text no-shadow` : 'no-shadow'}
                                             onClick={setUnit} checked={medicineUnit === MEDICINE_UNITS.ML}
                                             disabled={medicineUnit !== MEDICINE_UNITS.ML}>ml</RadioButton>
                                <RadioButton value={MEDICINE_UNITS.MG}
                                             className={medicineUnit !== MEDICINE_UNITS.MG ? `unselected-text no-shadow` : 'no-shadow'}
                                             onClick={setUnit} checked={medicineUnit === MEDICINE_UNITS.MG}
                                             disabled={medicineUnit !== MEDICINE_UNITS.MG}>mg</RadioButton>
                                {medicineUnit !== MEDICINE_UNITS.MG && (<RadioButton value={5}
                                                                                     className={medicineUnit !== MEDICINE_UNITS.ML ? `unselected-text no-shadow` : 'no-shadow'}
                                                                                     onClick={setStrength}
                                                                                     checked={medicineUnit === MEDICINE_UNITS.ML}
                                                                                     disabled={medicineUnit !== MEDICINE_UNITS.ML}>+5</RadioButton>)}
                                {medicineUnit !== MEDICINE_UNITS.MG && (<RadioButton value={-5}
                                                                                     className={medicineUnit !== MEDICINE_UNITS.ML ? `unselected-text no-shadow` : 'no-shadow'}
                                                                                     onClick={setStrength}
                                                                                     checked={medicineUnit === MEDICINE_UNITS.ML}
                                                                                     disabled={medicineUnit !== MEDICINE_UNITS.ML || currentMLCalibValue <= 5}>-5</RadioButton>)}
                                {medicineUnit !== MEDICINE_UNITS.ML && (<RadioButton value={50}
                                                                                     className={medicineUnit !== MEDICINE_UNITS.MG ? `unselected-text no-shadow` : 'no-shadow'}
                                                                                     onClick={setStrength}
                                                                                     checked={medicineUnit === MEDICINE_UNITS.MG}
                                                                                     disabled={medicineUnit !== MEDICINE_UNITS.MG}>+50</RadioButton>)}
                            </RadioGroup>
                        </div>
                    </div>
                    <InputGroup compact>
