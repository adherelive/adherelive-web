...
class EditWorkout extends Component {
    ...
    getAllWorkoutDetails = async () => {
        try {
            ...
            if (!status) {
                ...
                const {
                    all_workout_details = {},
                    all_workout_details: {days = [], start_time: {hours = '', minutes = ''} = {}} = {}
                } = this.props;
    ...
    handleSubmit = async () => {
        ...
        const {
            updateWorkout, carePlanId: care_plan_id = null, payload
        ...
        validateFields(async (err, values) => {
            ...
            if (!err) {
                ...
                if (name.length === 0 ||
                    ...
                    (addTemplateWorkout === null && editTemplateWorkout === null) && !care_plan_id
                ) {
                ...
                if (addTemplateWorkout === null && editTemplateWorkout === null) { // normal edit workout
    ...
    handleDelete = () => {
        ...
        const {warnNote} = this;
        const {payload: {workout_id = null, patient_id} = {}, getPatientCarePlanDetails} = this.props || {};
    ...
    getDeleteButton = () => {
        ...
        return (
            <Button
                ...
                onClick={
                    deleteWorkoutOfTemplate ? deleteWorkoutOfTemplate :
                        handleDelete
                }
                loading={loading}
            >
        ...
        return (
            <Fragment>
                <Drawer
                    ...
                    destroyOnClose={true}
                    onClose={
                        addTemplateWorkout || editTemplateWorkout
                            ? hideWorkout
                            : onClose
                    }
                    visible={
