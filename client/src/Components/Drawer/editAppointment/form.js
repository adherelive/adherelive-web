...
class EditAppointmentForm extends Component {
    ...
    componentDidMount = () => {
        ...
        let {
            basic_info: {
                details: {
                    type = '',
                    type_description: type_desc_initial = ''
                } = {}
            } = {}
        ...
        const {
            ...
            details: {appointment_type: details_appointment_type = '', type_description: details_type_desc = ''} = {}
        } = appointmentData || {};
    ...
    render() {
        ...
        let {
            basic_info: {
                description, start_date, start_time, end_time, details: {
                    radiology_type = '', treatment_id = "",
                    reason = '', type = '', type_description = '', critical = false
                } = {}
            } = {},
            provider_id = 0, provider_name = ''
        } = appointments[appointment_id] || {};
        ...
        let {
            reason: res = '', provider_id: provId = 0, provider_name: provName = '',
            schedule_data: {
                description: des = '',
                date: Date = '',
                    ...
                    <div className='flex flex-1 direction-column mr16'>
                        ...
                        >
                            {getFieldDecorator(START_TIME, {
                                ...
                                >
                                    <div
                                        className={`p10 br-brown-grey br5 wp100 h50 flex align-center justify-space-between pointer ${canViewDetails ? "disabled-field-form" : null} `}>
