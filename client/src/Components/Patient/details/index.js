...
const columns_medication = [
  ...
  },
  {
    ...
    dataIndex: 'edit',
    key: 'edit',
    render: () => <div className="edit-medication"><img src={edit_image} className="edit-medication-icon"/></div>
  }
];
      ...
      formatMessage
          ...
          return (
            <div className="patient-card tac" >
              <img alt="" className="patient-dp mt20 mr0 mb0 ml0" src={patient_display_picture}/>
              <div className="patient-name mt8 mr0 mb0 ml0">
                {patient_first_name} {patient_middle_name} {patient_last_name} ({gender} {patient_age}) 
              </div>
              <div className="patient-id mt6 mr0 mb0 ml0 ">PID: {patient_id}</div>
              <div className="patient-contact-number mt16 mr0 mb0 ml0">{patient_phone_number}</div>
              <div className="patient-email-id mt8 mr0 mb0 ml0">{patient_email_id}</div>
              <div className="action-buttons flex">
                <div className="edit-button p10">
                  <img className="mr5" src={edit_image}/><span>{formatMessage(message.profile_edit)}</span>
                </div>
                <div className="chat-button p10">
                  <img className="mr5" src={chat_image}/><span>{formatMessage(message.profile_chat)}</span>
                </div>
              </div>
            </div>
          );
            ...
            <div className="treatment mt20">
              ...
              <div className="treatment-details pl16 pr16">
                ...
                <div className="treatment-severity flex mt10">
                  ...
                  <div className="w60 wba tdh"><div className={`severity-label mr4 bg-${SEVERITY_STATUS[treatment_severity_status].color}`}></div>{SEVERITY_STATUS[treatment_severity_status].text}</div>
                </div>
                <div className="treatment-condition flex mt10">
                  <div className="w40">{formatMessage(message.treatment_condition)}</div>
                ...
                <div className="treatment-start-date flex mt10">
                  <div className="w40">{formatMessage(message.treatment_start_date)}</div>
...
class PatientDetails extends Component {
  ...
  render() {
    ...
    if(loading){
      return <div className="page-loader"><Spin size="large"></Spin></div>
    }
