        ...
        return (
            <Fragment>
                <Tabs defaultActiveKey={ALL_TABS.PUBLIC} activeKey={currentTab} onTabClick={changeTab}>
                    ...
                    >
                        <MedicineTable currentTab={ALL_TABS.PUBLIC}
                                       totalPublicMedicinesCount={totalPublicMedicinesCount} changeTab={changeTab}/>
                    </TabPane>
                    <TabPane tab={formatMessage(messages.creator_text)} key={ALL_TABS.CREATOR}>
                        <MedicineTable currentTab={ALL_TABS.CREATOR}
                                       totalPrivateMedicinesCount={totalPrivateMedicinesCount} changeTab={changeTab}/>
                    </TabPane>
                </Tabs>
            </Fragment>
        )
