...
import {BarChartOutlined, CreditCardOutlined, DeleteTwoTone, WalletOutlined} from "@ant-design/icons";
                ...
                <span>{upi_id ? upi_id : TABLE_DEFAULT_BLANK_FIELD}</span>
...

                    {
                        ...
                        <div className="flex  align-center justify-space-evenly wp100 mb10">
                            ...
                            {/* </div> */}
                            <Tooltip className="absolute t10 r10 account-details-delete"
