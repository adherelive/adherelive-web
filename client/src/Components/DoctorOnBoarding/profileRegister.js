...
class Profileregister extends Component {
    ...
    fetchData = async () => {
        ...
        const {
            basic_info: {email = '', mobile_number = '', prefix: newPrefix = ''} = {},
            category = ''
    ...
    onNextClick = () => {
        ...
        if (validate) {
            ...
            const data = {
                ...
                signature_pic: signature_pic_url ? signature_pic_url : signature_pic_url_saved
            };
            ...
            doctorProfileRegister(data).then(response => {
                ...
                const {
                    status,
                    statusCode,
                    payload: {message: res_message = '', data: {doctors: response_doctors = {}} = {}} = {}
                } = response;
    ...
    searchEmail = async (email) => {
        try {
            ...
            const {status, statusCode, payload: {message: res_message = ''} = {}} = response || {};
    ...
    renderProfileForm = () => {
        ...
        return (
            <div className='form-block'>
                ...
                >
                    {profile_pic ?
                        <img src={profile_pic} alt="avatar" style={{width: '100%'}}/> : profile_pic_url_saved ?
                            <img src={profile_pic_url_saved} alt="avatar" style={{width: '100%'}}/> : uploadButton}
                </Upload>
                ...
                >
                    ...
                    {signature_pic ? <img src={signature_pic} alt="signature picture"
                                          style={{width: '100%'}}/> : signature_pic_url_saved ?
                        <img src={signature_pic_url_saved} alt="signature picture"
                ...
                <Select
                    ...
                    notFoundContent={searchingMail
                        ? <Spin size="small"/>
                        : email.length ? 'No match found' : null}
                    autoComplete="off"
            ...
            <Fragment>
                ...
                <div className='registration-container'>
                    ...
                    <div className='footer'>
                        ...
                        <div className={'footer-text-active'}
                             onClick={this.onNextClick}>{this.formatMessage(messages.next)}</div>
                    </div>
                </div>
            </Fragment>
        );
