    ...
    renderProfileForm = () => {
        const prefixSelector = (
            ...
            <Select className="flex align-center h50 w70"
                ...
                {/* australia */}
                <Option value="61">
                    <div className='flex align-center'><Icon type="flag" theme="filled"/>
            ...
            <Fragment>
                ...
                <div className='registration-container'>
                    ...
                    <div className='footer'>
                        <div className={step > 0 ? 'footer-text-active' : 'footer-text-inactive'}
                             onClick={step != 0 ? this.onBackClick : null}>Back
                        </div>
                        <div className={step < 2 ? 'footer-text-active' : 'footer-text-inactive'}
                             onClick={step < 2 ? this.onNextClick : null}>Next
                        </div>
                    </div>
                </div>
            </Fragment>
