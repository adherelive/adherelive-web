                                        ...
                                        <div className="h200 wp100">
                                            ...
                                            <div className="login-text">
                                                <div className="fs16 medium">
                                                    {" "}
                                                    <b> Remote Care Enablement "For the Provider, by the Provider, to
                                                        their Patients" </b> <br/>
                                                    <b> Subscription based health care service delivery. </b> <br/>
                                                    <br/>
                                                    {" "}
                                                </div>
                                            </div>
                    ...
                    {props => (
                        <div className="form-container" style={props}>
                            ...
                            <div className="flex wp100 justify-center">
                                <a href={`mailto:${config.ADHERE_LIVE_CONTACT_LINK}?subject=${config.mail.LOGIN_CONTACT_MESSAGE}`}
                                   target={"_blank"} className="medium fs14 dark-sky-blue pointer">
