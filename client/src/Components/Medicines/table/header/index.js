  ...
  // }else{
    ...
    return [
        ...
        },
      {
        ...
        ...TABLE_COLUMN.OPTIONS,
        render: (data={}) => {
        const {medicineData = {}, makeMedicinePublic ,currentPage = null ,getPrivateMedicines ,
        changeLoading  , searchText='',mapMedicineToPublic , deleteMedicine ,
        getPublicMedicines , currentTab} = data;
        return (<Options medicineData={medicineData} makeMedicinePublic={makeMedicinePublic}
