...
export const deleteCareplanTemplateMedication = (careplan_template_id,other_id)   => {
    return `/care-plan-templates/${careplan_template_id}?medication=${other_id}`
}

export const deleteCareplanTemplateAppointment = (careplan_template_id,other_id)   => {
