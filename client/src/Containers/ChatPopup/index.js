...
const mapStateToProps = state => {
    const { twilio, users, auth: { authenticated_user = 1 } = {}, chats, chatMessages, symptoms, upload_documents, doctors, patients } = state;
    return { twilio, users, authenticated_user, chats, chatMessages, symptoms, upload_documents, doctors, patients };
};
