...
import { searchMedicine, getPublicMedicines , 
  getPrivateMedicines,makeMedicinePublic,
  resetSearchPrivate,resetSearchPublic,mapMedicineToPublic,deleteMedicine} from "../../modules/medicines";
import {open} from "../../modules/drawer";
import {DRAWER} from "../../constant";

const mapStateToProps = state => {
  const {medicines = {},
  pages:{ admin_medicines = {} , 
...
const mapDispatchToProps = dispatch => {
    return {
      ...
      makeMedicinePublic:({medicine_id,offset}) => dispatch(makeMedicinePublic({medicine_id,offset})),
      ...
      deleteMedicine : ({medicine_id,offset}) => dispatch(deleteMedicine({medicine_id,offset}))
    };
};
