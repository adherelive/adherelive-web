...
export const GET_ADMIN_PAYMENT_PRODUCT_COMPLETE = "GET_ADMIN_PAYMENT_PRODUCT_COMPLETE";
export const GET_ADMIN_PAYMENT_PRODUCT_FAILED = "GET_ADMIN_PAYMENT_PRODUCT_FAILED";

export const GET_DOCTOR_PAYMENT_PRODUCT = "GET_DOCTOR_PAYMENT_PRODUCT";
export const GET_DOCTOR_PAYMENT_PRODUCT_COMPLETE = "GET_DOCTOR_PAYMENT_PRODUCT_COMPLETE";
export const GET_DOCTOR_PAYMENT_PRODUCT_FAILED = "GET_DOCTOR_PAYMENT_PRODUCT_FAILED";

export const ADD_DOCTOR_PAYMENT_PRODUCT = "ADD_DOCTOR_PAYMENT_PRODUCT";
export const ADD_DOCTOR_PAYMENT_PRODUCT_COMPLETE = "ADD_DOCTOR_PAYMENT_PRODUCT_COMPLETE";
export const ADD_DOCTOR_PAYMENT_PRODUCT_FAILED = "ADD_DOCTOR_PAYMENT_PRODUCT_FAILED";

export const DELETE_DOCTOR_PAYMENT_PRODUCT = "DELETE_DOCTOR_PAYMENT_PRODUCT";
export const DELETE_DOCTOR_PAYMENT_PRODUCT_COMPLETE = "DELETE_DOCTOR_PAYMENT_PRODUCT_COMPLETE";
export const DELETE_DOCTOR_PAYMENT_PRODUCT_FAILED = "DELETE_DOCTOR_PAYMENT_PRODUCT_FAILED";
