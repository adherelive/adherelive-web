...
export const UPLOAD_APPOINTMENT_DOCUMENT_START = "UPLOAD_APPOINTMENT_DOCUMENT_START";
export const UPLOAD_APPOINTMENT_DOCUMENT_COMPLETE = "UPLOAD_APPOINTMENT_DOCUMENT_COMPLETE";
export const UPLOAD_APPOINTMENT_DOCUMENT_FAILED = "UPLOAD_APPOINTMENT_DOCUMENT_FAILED";

export const DELETE_APPOINTMENT_DOCUMENT_START = "DELETE_APPOINTMENT_DOCUMENT_START";
export const DELETE_APPOINTMENT_DOCUMENT_COMPLETE = "DELETE_APPOINTMENT_DOCUMENT_COMPLETE";
export const DELETE_APPOINTMENT_DOCUMENT_FAILED = "DELETE_APPOINTMENT_DOCUMENT_FAILED";
