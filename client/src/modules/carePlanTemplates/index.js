...
export const CREATE_CAREPLAN_TEMPLATE_FAILED = "CREATE_CAREPLAN_TEMPLATE_FAILED";

export const UPDATE_CAREPLAN_TEMPLATE_START = "UPDATE_CAREPLAN_TEMPLATE_START";
export const UPDATE_CAREPLAN_TEMPLATE_COMPLETED = "UPDATE_CAREPLAN_TEMPLATE_COMPLETED";
export const UPDATE_CAREPLAN_TEMPLATE_FAILED = "UPDATE_CAREPLAN_TEMPLATE_FAILED";

export const DUPLICATE_CAREPLAN_TEMPLATE_START = "DUPLICATE_CAREPLAN_TEMPLATE_START";
export const DUPLICATE_CAREPLAN_TEMPLATE_COMPLETED = "DUPLICATE_CAREPLAN_TEMPLATE_COMPLETED";
export const DUPLICATE_CAREPLAN_TEMPLATE_FAILED = "DUPLICATE_CAREPLAN_TEMPLATE_FAILED";

export const DELETE_CAREPLAN_TEMPLATE_RELATED_START = "DELETE_CAREPLAN_TEMPLATE_RELATED_START";
export const DELETE_CAREPLAN_TEMPLATE_RELATED_COMPLETED = "DELETE_CAREPLAN_TEMPLATE_RELATED_COMPLETED";
export const DELETE_CAREPLAN_TEMPLATE_RELATED_FAILED = "DELETE_CAREPLAN_TEMPLATE_RELATED_FAILED";
...
export const GET_ALL_TEMPLATES_FOR_DOC_FAILED = "GET_ALL_TEMPLATES_FOR_DOC_FAILED";
