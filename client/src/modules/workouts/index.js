...
export const GET_SINGLE_WORKOUT_DETAILS_START = "GET_SINGLE_WORKOUT_DETAILS_START";
export const GET_SINGLE_WORKOUT_DETAILS_COMPLETED = "GET_SINGLE_WORKOUT_DETAILS_COMPLETED";
export const GET_SINGLE_WORKOUT_DETAILS_FAILED = "GET_SINGLE_WORKOUT_DETAILS_FAILED";


export const GET_WORKOUTS_FOR_PATIENT_START = "GET_WORKOUTS_FOR_PATIENT_START";
export const GET_WORKOUTS_FOR_PATIENT_COMPLETED = "GET_WORKOUTS_FOR_PATIENT_COMPLETED";
export const GET_WORKOUTS_FOR_PATIENT_FAILED = "GET_WORKOUTS_FOR_PATIENT_FAILED";
...
export const GET_WORKOUT_DETAILS_FOR_RESPONSE_START = "GET_WORKOUT_DETAILS_FOR_RESPONSE_START";
