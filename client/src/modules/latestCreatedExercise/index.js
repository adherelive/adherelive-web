...
function latestExerciseCreatedReducer(state, data) {
  const { exercises : payloadExercises ={} , exercise_details : payloadExerciseDetails = {} , exercise_id = null , exercise_detail_id = null , exercise_contents = {}  } = data || {};
  let createdExerciseData = {} , createdExerciseDetaildData = {};
